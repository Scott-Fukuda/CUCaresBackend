...
if env == "staging":
    ...
    CORS(app, origins=["https://campuscares.us", "https://www.campuscares.us", "https://cu-cares-frontend-git-feature-multiopp-scotts-projects-851bba1b.vercel.app"], supports_credentials=True)
