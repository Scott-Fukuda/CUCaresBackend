...
# Special Endpoints
@app.route('/register/<int:user_id>/<int:opp_id>', methods=['POST'])
def register_user(user_id, opp_id):
    """Register specified user to specified opportunity"""
