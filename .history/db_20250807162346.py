...
class UserOpportunity(db.Model):
    ...
    user = db.relationship("User", back_populates="user_opportunities", cascade="all, delete-orphan")
    opportunity = db.relationship("Opportunity", back_populates="user_opportunities", cascade="all, delete-orphan")
...
class Opportunity(db.Model):
    ...
    user_opportunities = db.relationship('UserOpportunity', back_populates='opportunity', cascade="all, delete-orphan")
