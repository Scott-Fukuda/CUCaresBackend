...
def marked_as_attended():
    ...
    try:
        ...
        if existing:
            existing.attendeded = True  # Correct the spelling if your column is 'attendeded' or fix it to 'attended'
            db.session.commit()
...
@app.route('/orgs/<int:org_id>', methods=['GET'])
...
@app.route('/opps/<int:opp_id>', methods=['GET'])
...
@app.route('/opps/<int:opp_id>', methods=['PUT'])
...
@app.route('/opps/<int:opp_id>', methods=['DELETE'])
